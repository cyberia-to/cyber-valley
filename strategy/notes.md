...
a single night-only hero ([[sinwood]]) leaves daylight monetisation gaps; think daytime micro-ateliers (mushroom dye, bamboo joinery, "code-in-the-canopy" desks). [[etherland]] packs many functions; without curated programming it can feel generic gym-plus-cowork.

## residency draft rates

draft pricing for a future residency tier — to be confirmed.
