...
alias: leasehold upfront, upfront leasehold, upfront lease
crystal-type: pattern
crystal-domain: cyberia
---
# leasehold upfront

a 25-year [[hak sewa]] — the Indonesian lease right — on [[development|cyber valley]] land, paid in full at signing. instrument A of the [[development|strategy]].

the resident's instrument: one payment, a notarized hak sewa from PT PMA with extension of right priced on the [[century index]] — quantities qᵢ and the floor are fixed at signing, the invoice moves with the basket — and the plot is yours to build. it is a lease right, not a title: it is not registered at BPN and does not appear on the certificate. [[hak pakai]] (D) and [[hak milik]] (E) are the registered channels.
